function [jacobian_cell,sol,sol_labels] = symbolic_transf_loss()

%Symbolic version of transformation model with finite loss rates

syms rho rhop c gammat Gamma alpha1 Delta delta1 Np p delta2 rl

base1 = alpha1*c*rho - gammat*rho*p - delta1*rho + (1-Delta)*alpha1*c*rhop*rl;
base2 = (1-Delta)*alpha1*c*rhop + gammat*rho*p - delta1*rhop - (1-Delta)*alpha1*c*rhop*rl;
